...
public class ChatComplexFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_chat_complex, container, false);
...
//                });
        dups.clear();
        dupr.clear();
        recyclerView = root.findViewById(R.id.chatComRecycler);
